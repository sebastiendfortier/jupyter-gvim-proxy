![build](https://github.com/sebastiendfortier/jupyter-gvim-proxy/workflows/build/badge.svg)
...
(incl. [jupyter-server-proxy](https://github.com/jupyterhub/jupyter-server-proxy), [jupyter-gvim-proxy](https://github.com/sebastiendfortier/jupyter-gvim-proxy) and [Xpra-HTML5](https://xpra.org/))
...
```
pip install git+https://github.com/sebastiendfortier/jupyter-gvim-proxy.git
```
